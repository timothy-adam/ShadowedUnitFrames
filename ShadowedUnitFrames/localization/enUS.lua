...
L["Adds a bar inside the health bar indicating how much healing will be absorbed."] = "Adds a bar inside the health bar indicating how much healing will be absorbed."
...
L["Health bar color used to show healing that will be absorbed."] = "Health bar color used to show healing that will be absorbed."
...
L["Percentage value of how far outside the unit frame the healing absorb bar can go. 130% means it will go 30% outside the frame, 100% means it will not go outside."] = "Percentage value of how far outside the unit frame the healing absorb bar can go. 130% means it will go 30% outside the frame, 100% means it will not go outside."
